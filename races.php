...
<head>
	...
	<title>Crônicas de Omeria</title>
		...
		<link href="https://fonts.googleapis.com/css?family=Raleway+Display:400,400i|Roboto:400,500" rel="stylesheet">
...
<body>
	...
	<!--================ Start Header Area =================-->
	<!-- it is in php on top of this document -->
				...
				<div class="header-top d-flex justify-content-between align-items-center navbar-expand-md">
					<div class="col menu-left ">
						<div class="d-flex justify-content-around">
							...
							<a class="active" href="omeria.php">Mundo</a>
							...
							<ul class="navbar-nav justify-content-around w-100">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu">
										...
										<a class="dropdown-item" href="blog-single.html">Detalhes Blog</a>
									</div>
								</li>
								<li class="nav-item">
	...
	<!--================ Start About Area =================-->
		<section class="section-gap-top about-area" id="menu_area">
			<div class="container">
				<div class="single-about row align-items-center">
					...
					<div class="col-lg-7 col-md-6 text-center no-padding about-right">
						<div class="about-thumb">
							<img src="img/about-img1.png" class="img-fluid info-img" alt="">
						</div>
					</div>
					<div class="bordered-img">
						<img src="img/about-img2.png" class="img-fluid info-img" alt="">
					</div>
				</div>
			</div>
		</section>
						...
						<div class="single-menu">
							...
							<ul class="list">
								...
								<li>
									...
									<p>Descendentes dos extintos elfos, os elfanires se dividem em sol, terra e a lua. <br> Cada um domina um dos grandes astros.</p>
								</li>
								<li>
									<p class="menu-item">Hartlif</p>
									<p>A natureza é a essência da vida. <br> Todo hartlif tem uma árvore-berço que possui uma forte ligação.</p>
								</li>
								<li>
									<p class="menu-item">Nero</p>
									<p>Os neros e neríades são parecidos com humanos, mas com guelras. <br>Cada indivíduo possui uma concha única que protege o seu coração.</p>
								</li>
								<li>
									<p class="menu-item">Obscur</p>
									<p> Obscures são pessoas que foram tocadas pela escuridão. <br> Tornando pelo menos uma parte de seu corpo como a de um demônio.</p>
								</li>
								<li>
									<p class="menu-item">Pendragon</p>
									<p>Um poderoso, temido e até então extinto sangue corre em suas veias, <br>o sangue de um dragão.</p>
								</li>
								<li>
									<p>...e muito mais...</p>
								</li>
		...
		<div class="container">
			...
			<div class="footer-bottom row align-items-center justify-content-between">
				<p class="footer-text m-0 col-lg-6 col-md-12">Copyright © 2018 All rights reserved | This template is made with
					<span class="lnr lnr-heart"></span> by <a href="https://colorlib.com/" target="_blank">Colorlib</a></p>
