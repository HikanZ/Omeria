...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Omeria | Crônicas de Omeria</title>
			...
			<div class="row justify-content-center">
				<div class="col-md-8 text-center">
					<div class="section-title">
						<h1>Conheça os <br>nossos heróis</h1>
			    ...
			    <div class="col-md-2 col-md-offset-1">
						<div class="our-team">
							...
							<div class="team-content">
									...
									<span class="post">Dungeon Master</span>
							</div>
						</div>
					</div>
			    <div class="col-md-2">
						<div class="our-team">
							...
							<div class="team-content">
									<h3 class="title">Barbara</h3>
									<span class="post">Pendragon Rogue</span>
							</div>
						</div>
					</div>
			    <div class="col-md-2">
						<div class="our-team">
							...
							<div class="team-content">
									...
									<span class="post">Humano Bárbaro</span>
							</div>
						</div>
					</div>
			    <div class="col-md-2">
						<div class="our-team">
							...
							<div class="team-content">
									<h3 class="title">Bruno</h3>
									<span class="post">Nero Warlock</span>
							</div>
						</div>
					</div>
			    <div class="col-md-2">
						<div class="our-team">
							...
							<div class="team-content">
									<h3 class="title">Paulo</h3>
									<span class="post"><del>Elfrit Ranger</del></span>
							</div>
						</div>
					</div>
			</div>
